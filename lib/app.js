...
if (process.env.ROLLBAR_KEY) {
  rollbar.init(process.env.ROLLBAR_KEY, {handler: 'setInterval', handlerInterval: 5});
  rollbar.handleUncaughtExceptions(process.env.ROLLBAR_KEY);
}
